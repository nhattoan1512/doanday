...
// Header Login
const loginBtns = document.querySelectorAll('.js-login-ticket')
        ...
        // Hàm hiển thị modal
        function showLoginTickets() {
            modalLogin.classList.add('open')
        }

        // Hàm ẩn modal 
        function hideLoginTickets() {
            modalLogin.classList.remove('open')
        }

        // Lặp qua từng thẻ button và nghe hành vi click
        for (const loginBtn of loginBtns) {
            loginBtn.addEventListener('click', showLoginTickets)
        }

        // Nghe hành vi click bào button close
        modalClose.addEventListener('click', hideLoginTickets)

        modal.addEventListener('click', hideLoginTickets)
